import { renamePresentation, addSlide, removeSlide, moveSlide, addElementToSlide, removeElementsFromSlide, changeElPosition, changeElSize, changeTextElContent, changeFontFamily, changeSlideBg, setSelectedSlides, setSelectedElements, } from "../lw1_4/functions/functions";
...
const minimalRGBColor = "rgb(0, 0, 0)";
const minimalHEXColor = "#000000";
const minimalColor = minimalRGBColor;
const minimalGradient = {
    angle: 0,
    colors: [minimalRGBColor, minimalHEXColor]
};
const minimalImageBackground = {
    type: 'image',
    data: 'data:image/png;base64,minimal'
};
const minimalSolidColorBackground = {
    type: 'solid',
...
const maxRGBColor = "rgb(255, 128, 64)";
const maxHEXColor = "#FF8040";
const maxColor1 = maxRGBColor;
const maxColor2 = maxHEXColor;
const maxGradient = {
    angle: 45,
    colors: [maxRGBColor, maxHEXColor, "rgb(0, 255, 0)", "#00F"]
};
const maxImageBackground = {
    type: 'image',
    data: 'data:image/jpeg;base64,maximal1'
};
const maxSolidColorBackground = {
    type: 'solid',
    color: maxRGBColor
};
const maxGradientBackground = {
    type: 'gradient',
    gradient: maxGradient
};
const maxBackground1 = maxImageBackground;
const maxBackground2 = maxSolidColorBackground;
const maxBackground3 = maxGradientBackground;
const maxImageElement1 = {
    id: "img1",
    type: 'image',
...
function testFunctions() {
    ...
    const textElement = afterContentChange.slides[0].elements[0];
    ...
    const textElementAfterFont = afterFontChange.slides[0].elements[0];
    ...
    console.log("changeSlideBg minimal:", ((_a = afterBgChange.slides[0].background) === null || _a === void 0 ? void 0 : _a.type) === 'solid');
    ...
    console.log("addElementToSlide maximal:", (targetSlide === null || targetSlide === void 0 ? void 0 : targetSlide.elements.length) === 3);
    // 6. removeElementsFromSlide
    ...
    console.log("removeElementsFromSlide maximal:", (slideAfterRemove === null || slideAfterRemove === void 0 ? void 0 : slideAfterRemove.elements.length) === 1);
    // 7. changeElPosition
    const newMaxPosition = { x: "150", y: "250" };
    const afterMaxPositionChange = changeElPosition("slide1", "img1", newMaxPosition, maxPresentation);
    const elementAfterPosition = (_b = afterMaxPositionChange.slides.find(s => s.id === "slide1")) === null || _b === void 0 ? void 0 : _b.elements.find(e => e.id === "img1");
    console.log("changeElPosition maximal:", (elementAfterPosition === null || elementAfterPosition === void 0 ? void 0 : elementAfterPosition.position.x) === "150");
    // 8. changeElSize
    const newMaxSize = { width: "600", height: "400" };
    const afterMaxSizeChange = changeElSize("slide1", "img1", newMaxSize, maxPresentation);
    const elementAfterSize = (_c = afterMaxSizeChange.slides.find(s => s.id === "slide1")) === null || _c === void 0 ? void 0 : _c.elements.find(e => e.id === "img1");
    console.log("changeElSize maximal:", (elementAfterSize === null || elementAfterSize === void 0 ? void 0 : elementAfterSize.size.width) === "600");
    // 9. changeTextElContent
    const afterMaxContentChange = changeTextElContent("slide1", "text1", "Updated maximal content", maxPresentation);
    const textElementMax = (_d = afterMaxContentChange.slides.find(s => s.id === "slide1")) === null || _d === void 0 ? void 0 : _d.elements.find(e => e.id === "text1");
    console.log("changeTextElContent maximal:", (textElementMax === null || textElementMax === void 0 ? void 0 : textElementMax.content) === "Updated maximal content");
    // 10. changeFontFamily
    const afterMaxFontChange = changeFontFamily("slide1", "text1", "Georgia", maxPresentation);
    const textElementAfterMaxFont = (_e = afterMaxFontChange.slides.find(s => s.id === "slide1")) === null || _e === void 0 ? void 0 : _e.elements.find(e => e.id === "text1");
    console.log("changeFontFamily maximal:", (textElementAfterMaxFont === null || textElementAfterMaxFont === void 0 ? void 0 : textElementAfterMaxFont.fontFamily) === "Georgia");
    // 11. changeSlideBg
    ...
    console.log("changeSlideBg maximal:", ((_f = slideAfterBgChange === null || slideAfterBgChange === void 0 ? void 0 : slideAfterBgChange.background) === null || _f === void 0 ? void 0 : _f.type) === 'gradient');
    // 12. setSelectedSlides
    ...
    console.log("setSelectedElements maximal:", afterMaxElementSelect.selection.selectedElementIds.includes("img2") &&
